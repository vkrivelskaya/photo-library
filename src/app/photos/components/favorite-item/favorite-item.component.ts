...
export class FavoriteItemComponent {
  ...
  constructor(private route: ActivatedRoute, private router: Router, public store: Store<{ favoritesPhotos: FavoritesState }>) {}

  public onRemoveButtonClick(): void {
    this.store.dispatch(FavoritesPhotosActions.RemoveFavoritePhoto({ photo: this.photo }));
